...
<div class="content-wrapper" style="min-height: 1244.06px;">
    ...
    <section class="content">
        <form action="{{ route('admin.get.create.product') }}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
                        ...
                        <div class="col-md-12">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Tên sản phẩm" value="{{ old('product_name', isset($product->product_name) ?  $product->product_name : '')}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea cols="30" rows="10" type="text" class="form-control" name="product_content" id="product_content" placeholder="Nội dung" value="{{ old('product_content', isset($product->product_content) ?  $product->product_content : '')}}"></textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="product_category_id" class="form-control"> 
                                            ...
                                            <option value="{{$product->id}}">{{$product->categories_name}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" name="product_sale" placeholder="Khuyến mãi" value="{{ old('product_sale', isset($product->product_sale) ?  $product->product_sale : '')}}">
                                    </div>
                                </div>
                                <div class="form-group row">
