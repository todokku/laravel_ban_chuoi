                ...
                <form class="form-horizontal">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea cols="30" rows="10" type="text" class="form-control" name="post_content" id="post_content" placeholder="Nội dung" value="{{ old('post_content', isset($post->post_content) ?  $post->post_content : '')}}">{{ old('post_content', isset($post->post_content) ?  $post->post_content : '')}}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="custom-file">
                                    ...
                                    <input type="file" data-icon="false" name="post_avatar" class="form-control" value="{{ old('post_avatar', isset($post->post_avatar) ?  $post->post_avatar : '')}}">
                                    
                                </div>      
                                <!-- <label for="post_avatar">File: {{ old('post_avatar', isset($post->post_avatar) ?  $post->post_avatar : '')}}</label>                      -->
                            </div>
                        </div>
                    </div>
